<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="PictureDetail.aspx.cs" Inherits="PictureDetail" %>
...
<div id="Comment" style=" direction:rtl">
    ...
    <asp:SqlDataSource ID="NewsCommentsDataSource" runat="server" 
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="NBPVID" QueryStringField="PictureID" 
                Type="Int32" />
            <asp:Parameter DefaultValue="2" Name="CommentType" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
