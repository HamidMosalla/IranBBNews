<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="International.aspx.cs" Inherits="NewsSubPage_International" %>
...
<div id="subpage1">
    <span style="font-size: medium; color: #990000">خبرهای بین المللی</span>
    <br />
    <br />
<div id="contentpost">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="6" Name="SubjectIDfk" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
...
<div id="subpage2">
 <span style="font-size: medium; color: #990000">آخرین عکس های بین المللی</span>
    <br />
    <br />
...
<div id="subpage3">
     ...
     <span style="font-size: medium; color: #990000">آخرین مطالب بین المللی بلاگستان</span>
    <br />
    <br />
...
<span style="font-size: medium; color: #990000">آخرین ویدئوهای بین المللی</span>
    <br />
    <br />
