<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Cultural.aspx.cs" Inherits="NewsSubPage_Cultural" %>
...
<div id="subpage1">
    <span style="font-size: medium; color: #990000">خبرهای فرهنگی</span>
    <br />
    <br />
<div id="contentpost">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="3" Name="SubjectIDfk" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
...
<div id="subpage2">
 <span style="font-size: medium; color: #990000">آخرین عکس های فرهنگی</span>
    <br />
    <br />
...
<div id="subpage3">
     ...
     <span style="font-size: medium; color: #990000">آخرین مطالب فرهنگی بلاگستان</span>
    <br />
    <br />
...
<span style="font-size: medium; color: #990000">آخرین ویدئوهای فرهنگی</span>
    <br />
    <br />
