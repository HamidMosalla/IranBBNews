<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Satire.aspx.cs" Inherits="NewsSubPage_Satire" %>
...
<div id="subpage1">
    <span style="font-size: medium; color: #990000">خبرهای طنز</span>
    <br />
    <br />
<div id="contentpost">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="9" Name="SubjectIDfk" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
...
<div id="subpage2">
 <span style="font-size: medium; color: #990000">آخرین عکس های طنز</span>
    <br />
    <br />
...
<div id="subpage3">
     ...
     <span style="font-size: medium; color: #990000">آخرین مطالب طنز بلاگستان</span>
    <br />
    <br />
...
<span style="font-size: medium; color: #990000">آخرین ویدئوهای طنز</span>
    <br />
    <br />
