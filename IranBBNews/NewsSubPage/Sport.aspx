<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Sport.aspx.cs" Inherits="NewsSubPage_Sport" %>
...
<div id="subpage1">
    <span style="font-size: medium; color: #990000">خبرهای ورزشی</span>
    <br />
    <br />
<div id="contentpost">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="5" Name="SubjectIDfk" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
...
<div id="subpage2">
 <span style="font-size: medium; color: #990000">آخرین عکس های ورزشی</span>
    <br />
    <br />
...
<div id="subpage3">
     ...
     <span style="font-size: medium; color: #990000">آخرین مطالب ورزشی بلاگستان</span>
    <br />
    <br />
...
<span style="font-size: medium; color: #990000">آخرین ویدئوهای ورزشی</span>
    <br />
    <br />
