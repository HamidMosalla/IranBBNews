<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Politic.aspx.cs" Inherits="NewsSubPage_Politic" %>
...
<div id="subpage1">
    <span style="font-size: medium; color: #990000">خبرهای سیاسی</span>
    <br />
    <br />
<div id="contentpost">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="1" Name="SubjectIDfk" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
...
<div id="subpage2">
 <span style="font-size: medium; color: #990000">آخرین عکس های سیاسی</span>
    <br />
    <br />
...
<div id="subpage3">
     ...
     <span style="font-size: medium; color: #990000">آخرین مطالب سیاسی بلاگستان</span>
    <br />
    <br />
...
<span style="font-size: medium; color: #990000">آخرین ویدئوهای سیاسی</span>
    <br />
    <br />
