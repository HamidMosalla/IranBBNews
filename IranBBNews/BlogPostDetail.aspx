<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="BlogPostDetail.aspx.cs" Inherits="BlogPostDetail" %>
...
<br />
<p id="NewsDetailSummary" style="color:Silver" runat="server"></p>
<br />
<br />
<br />
<br />
...
<br />
<br />
<asp:Image Width="660px" Height="400px" ID="NewsDetailPicture" runat="server" />
<br />
<br />
    ...
    <%--<asp:Literal ID="NewsDetailContent" runat="server"></asp:Literal>--%>
...
<div id="Comment" style=" direction:rtl">
    ...
    <asp:SqlDataSource ID="NewsCommentsDataSource" runat="server" 
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="NBPVID" QueryStringField="BlogPostID" 
                Type="Int32" />
            <asp:Parameter DefaultValue="1" Name="CommentType" Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
